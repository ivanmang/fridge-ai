...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v--N1Fy1Tb.mjs");
...
var manifest = {
	"b96dc595b281c9885cf8cf0831546ddb6cf9c63212eb223defcf40a589993967": {
		functionName: "lookupDishes_createServerFn_handler",
		importer: () => import("./dish.functions-BRHq_J5b.mjs")
	},
	"f8fe3c4f8727056a09a9bad9289a72bed2607f138eff53664d118c82ec8aedc1": {
		functionName: "scanFoods_createServerFn_handler",
		importer: () => import("./scan.functions-D8Ky9_no.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-gEdvOObj.mjs").then((n) => n.t),
